...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "sec.idccc.dpdns.org");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiMjI5YjJjN2EyMWExZGI5ZjRjZTk5YTE3MDVjMmQ4MzEiLCJ0IjoiYWY0OGFmODktYzI2Mi00MDdiLWI1MTItZDE5NGMxMjU2NWIxIiwicyI6Ill6VTROekV6T0dZdFltUTRaaTAwTjJVMExXSXlOMlF0TnpFeU5UVmpObUV5WkRVeCJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取

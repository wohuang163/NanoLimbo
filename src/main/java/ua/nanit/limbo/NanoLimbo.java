...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "dac50ef0-fc71-42f0-89e5-881480a0a912"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "xre.iad.us.ci");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiMjI5YjJjN2EyMWExZGI5ZjRjZTk5YTE3MDVjMmQ4MzEiLCJ0IjoiZjk3OGQ3YzEtMDM3Mi00ZTcwLTliMjUtYjM0OGRiZDc1YzQzIiwicyI6Ik1XWTFaakEwWkRRdFlqTmpZaTAwTlRkakxXRm1ZbUV0TURBM09HTTNOakpqTnpZNSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "33237");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "30790");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "33237");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空

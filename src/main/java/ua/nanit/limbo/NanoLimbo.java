...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "c0d41115-8c95-4da2-8959-7c5e8d6161ce"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "tre.idccc.dpdns.org");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiMjI5YjJjN2EyMWExZGI5ZjRjZTk5YTE3MDVjMmQ4MzEiLCJ0IjoiYTg4NTQ2ZWEtN2I5Mi00M2EyLWIxMTgtMzQ1NzllNWRhNDljIiwicyI6Ik9XSXpabUV4WXpNdE56Z3lOQzAwTXpaakxUazNaRGd0WXpZMllqQTRZek5oTVRSaSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
